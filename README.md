...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,750 | 🐛 23 | 🌐 C | 📅 2026-09-04 - A superior fork to Google's AFL with more speed, more and better mutations, more and better instrumentation, and custom module support.
...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,319 | 🐛 626 | 🌐 Go | 📅 2026-09-09 (2015) - An unsupervised coverage-guided kernel fuzzer supporting FreeBSD, Fuchsia, gVisor, Linux, NetBSD, OpenBSD, and Windows.
...
* [WuppieFuzz](https://github.com/TNO-S3/WuppieFuzz) ⭐ 226 | 🐛 34 | 🌐 Rust | 📅 2026-09-09 - A coverage-guided REST API fuzzer developed on top of LibAFL.
