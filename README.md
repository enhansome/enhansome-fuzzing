...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,319 | 🐛 629 | 🌐 Go | 📅 2026-09-08 (2015) - An unsupervised coverage-guided kernel fuzzer supporting FreeBSD, Fuchsia, gVisor, Linux, NetBSD, OpenBSD, and Windows.
* [Trinity](https://github.com/kernelslacker/trinity) ⭐ 909 | 🐛 1 | 🌐 C | 📅 2026-09-03 (2012) - A Linux system call fuzzer that generates semi-intelligent random arguments to syscalls, including valid file descriptors, flags, and range-biased values.
...
* [WuppieFuzz](https://github.com/TNO-S3/WuppieFuzz) ⭐ 226 | 🐛 41 | 🌐 Rust | 📅 2026-09-07 - A coverage-guided REST API fuzzer developed on top of LibAFL.
