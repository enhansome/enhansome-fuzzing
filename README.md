...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,313 | 🐛 621 | 🌐 Go | 📅 2026-08-28 (2015) - An unsupervised coverage-guided kernel fuzzer supporting FreeBSD, Fuchsia, gVisor, Linux, NetBSD, OpenBSD, and Windows.
...
* [WuppieFuzz](https://github.com/TNO-S3/WuppieFuzz) ⭐ 223 | 🐛 37 | 🌐 Rust | 📅 2026-08-31 - A coverage-guided REST API fuzzer developed on top of LibAFL.
