...
* [Fuzzing-101](https://github.com/antonio-morales/Fuzzing101) ⭐ 3,811 | 🐛 28 | 📅 2026-06-16
...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,716 | 🐛 25 | 🌐 C | 📅 2026-08-15 - A superior fork to Google's AFL with more speed, more and better mutations, more and better instrumentation, and custom module support.
...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,299 | 🐛 615 | 🌐 Go | 📅 2026-08-14 (2015) - An unsupervised coverage-guided kernel fuzzer supporting FreeBSD, Fuchsia, gVisor, Linux, NetBSD, OpenBSD, and Windows.
* [Trinity](https://github.com/kernelslacker/trinity) ⭐ 905 | 🐛 1 | 🌐 C | 📅 2026-08-15 (2012) - A Linux system call fuzzer that generates semi-intelligent random arguments to syscalls, including valid file descriptors, flags, and range-biased values.
* [kAFL](https://github.com/rub-syssec/kafl) ⭐ 594 | 🐛 15 | 🌐 Python | 📅 2019-01-10 (2017) - A hardware-assisted x86-64 VM kernel fuzzing framework with performant VM reloads for finding OS kernel vulnerabilities.
...
* [Hydra](https://github.com/sslab-gatech/hydra) ⭐ 177 | 🐛 6 | 🌐 C | 📅 2022-08-08 (2019) - A fuzzing framework for automatically discovering semantic bugs in file systems using input mutators, feedback engines, and customizable checkers.
...
* [ACTOR](https://github.com/ucsb-seclab/actor) ⭐ 41 | 🐛 1 | 🌐 Go | 📅 2024-05-06 (2023) - An action-guided kernel fuzzing framework that generates inputs leveraging triggered actions and their temporal relationships.
...
* [WuppieFuzz](https://github.com/TNO-S3/WuppieFuzz) ⭐ 219 | 🐛 36 | 🌐 Rust | 📅 2026-08-14 - A coverage-guided REST API fuzzer developed on top of LibAFL.
