...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,754 | 🐛 24 | 🌐 C | 📅 2026-09-13 (2019) - A superior fork to Google's AFL with more speed, more and better mutations, more and better instrumentation, and custom module support.
* [LibAFL](https://github.com/AFLplusplus/LibAFL) ⭐ 2,643 | 🐛 121 | 🌐 Rust | 📅 2026-09-07 (2022) - A Rust framework for building custom fuzzers from reusable components, with support for multiple platforms and scaling across cores and machines.
...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,323 | 🐛 637 | 🌐 Go | 📅 2026-09-15 (2015) - An unsupervised coverage-guided kernel fuzzer supporting FreeBSD, Fuchsia, gVisor, Linux, NetBSD, OpenBSD, and Windows.
