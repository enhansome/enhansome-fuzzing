...
* [AFL++](https://github.com/AFLplusplus/AFLplusplus) ⭐ 6,743 | 🐛 22 | 🌐 C | 📅 2026-09-02 - A superior fork to Google's AFL with more speed, more and better mutations, more and better instrumentation, and custom module support.
...
* [syzkaller](https://github.com/google/syzkaller) ⭐ 6,313 | 🐛 630 | 🌐 Go | 📅 2026-09-02 (2015) - An unsupervised coverage-guided kernel fuzzer supporting FreeBSD, Fuchsia, gVisor, Linux, NetBSD, OpenBSD, and Windows.
...
* [WuppieFuzz](https://github.com/TNO-S3/WuppieFuzz) ⭐ 223 | 🐛 34 | 🌐 Rust | 📅 2026-09-01 - A coverage-guided REST API fuzzer developed on top of LibAFL.
